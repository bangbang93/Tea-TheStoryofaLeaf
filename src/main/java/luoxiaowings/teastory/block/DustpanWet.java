...
public class DustpanWet extends Block
{
	public DustpanWet()
	{
		super(Material.wood);
        ...
        this.setUnlocalizedName("dustpan_wet");
	}
	...
	public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    worldIn.setBlockState(pos, BlockLoader.dustpan_full.getDefaultState(), 2);
                }
            }
        }
    }
	...
	protected static float getGrowthChance(Block blockIn, World worldIn, BlockPos pos)
    {
        ...
        } else
        {
        	if (isDaytime)
        	{
        		f = worldIn.getLightFromNeighbors(pos.up()) * 0.04F;
        	}
        	else
        	{
        		f = worldIn.getLightFromNeighbors(pos.up()) * 0.015F;
        	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            ItemStack itemstack1 = new ItemStack(ItemLoader.wet_tea, 8);
